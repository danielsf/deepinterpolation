...
class OphysGenerator(SequentialGenerator):
    ...
    def __index_generation__(self, index_frame):
        ...
        #    index_frame + self.post_frame + self.pre_post_omission + 1,
        #)
        input_index_left = np.arange(index_frame-self.pre_frame-self.pre_post_omission, index_frame)
        input_index_right = np.arange(index_frame+1, index_frame + self.post_frame + self.pre_post_omission + 1)
